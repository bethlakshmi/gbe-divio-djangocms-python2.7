    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    serialize=False,
                    verbose_name='ID')),
                ('track_title', models.CharField(blank=True,
                                                 max_length=128)),
                ('track_artist', models.CharField(blank=True,
                                                  max_length=123)),
                ('track', models.FileField(blank=True,
                                           upload_to=b'uploads/audio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[
                    (b'Class', b'Class'),
                    (b'Panel', b'Panel'),
                    (b'Either', b'Either')], default=b'Class', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[
                    ...
                    ], default=b'upcoming', max_length=50)),
                ('accepting_bids', models.BooleanField(default=False)),
                ('act_style', models.CharField(choices=[
                    (b'normal', b'normal'),
                    (b'summer', b'summer')
                    ], default=b'normal', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_spot', models.CharField(choices=[
                    (b'White', b'White'),
                    (b'Blue', b'Blue'),
                    (b'OFF', b'OFF'),
                    (b'Pink', b'Pink'),
                    (b'Purple', b'Purple'),
                    (b'Red', b'Red')
                    ], default=(b'White', b'White'), max_length=25)),
                ('center_spot', models.CharField(choices=[
                    (b'Off', b'OFF'),
                    (b'ON', b'ON')], default=b'OFF', max_length=20)),
                ('backlight', models.CharField(choices=[
                    (b'Off', b'OFF'),
                    (b'ON', b'ON')], default=b'OFF', max_length=20)),
                ('cyc_color', models.CharField(choices=[
                    (b'Blue', b'Blue'),
                    (b'Green', b'Green'),
                    (b'OFF', b'OFF'),
                    (b'Pink', b'Pink'),
                    ...
                    (b'White', b'White'),
                    (b'Yellow', b'Yellow')
                    ], default=(b'Blue', b'Blue'), max_length=25)),
                ('wash', models.CharField(choices=[
                    (b'White', b'White'),
                    (b'Blue', b'Blue'),
                    (b'Green', b'Green'),
                    (b'OFF', b'OFF'),
        ...
        migrations.CreateModel(
            name='Event',
            fields=[
                ('eventitem_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
        ...
        migrations.CreateModel(
            name='Performer',
            fields=[
                ('workeritem_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
                    primary_key=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    serialize=False,
                    verbose_name='ID')),
                ('festival', models.CharField(choices=[
                    (b'GBE', b'The Great Burlesque Exposition'),
                    (b'BHOF', b'Miss Exotic World/Burlesque Hall of Fame'),
                    (b'NYBF', b'New York Burlesque Festival'),
                    (b'NOBF', b'New Orleans Burlesque Festival'),
                    (b'TBF', b'Texas Burlesque Festival')], max_length=20)),
                ('experience', models.CharField(choices=[
                    (b'No', b'No'),
                    (b'Yes', b'Yes'),
                    (b'Won', b'Yes - and Won!')
                    ], default=b'No', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_email', models.CharField(
                    blank=True,
                    default=b'',
                    max_length=64)),
                ...
                ('state', models.CharField(blank=True, choices=[
                    ...
                    (b'WI', b'Wisconsin'),
                    (b'WY', b'Wyoming'),
                    (b'OTHER', b'Other/Non-US')], max_length=2)),
                ...
                ('phone', models.CharField(
                    ...
                    validators=[
                        django.core.validators.RegexValidator(
                            message=b'Phone numbers must be in a standard ' +
                            b'US format, such as ###-###-###.',
                            regex=b'(\\d{3}[-\\.]?\\d{3}[-\\.]?\\d{4})')])),
                ('best_time', models.CharField(blank=True, choices=[
                    (b'Any', b'Any'),
                    (b'Mornings', b'Mornings'),
                    (b'Afternoons', b'Afternoons'),
                    (b'Evenings', b'Evenings')
                    ], default=b'Any', max_length=50)),
                ('how_heard', models.TextField(blank=True)),
                ('user_object', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            name='Room',
            fields=[
                ('locationitem_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
                    primary_key=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    serialize=False,
                    verbose_name='ID')),
                ('vote', models.IntegerField(blank=True, choices=[
                    (1, b'Strong yes'),
                    (2, b'Yes'),
                    (3, b'Weak Yes'),
                    (4, b'No Comment'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_volunteers', models.IntegerField(
                    blank=True,
                    default=b'1',
                    null=True)),
                ('conference', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.IntegerField(
                    ...
                    choices=[(0, b'--------------'),
                             (1, b'Not interested'),
                             (2, b'Slightly interested'),
                             (3, b'Neither interested nor disinterested'),
                             (4, b'Somewhat interested'),
                             (5, b'Strongly interested')])),
                ('interest', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    to='gbe.AvailableInterest')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Act',
            fields=[
                ('actitem_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
                    to='scheduler.ActItem')),
                ('biddable_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
                    primary_key=True,
                ...
                ('video_choice', models.CharField(blank=True, choices=[
                    (b'0', b"I don't have any video of myself performing"),
                    (b'1',
                     b"This is video of me but not the act I'm submitting"),
                    (b'2', b'This is video of the act I would like to perform')
                    ], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biddable_ptr', models.OneToOneField(
                    ...
                    serialize=False,
                    to='gbe.Biddable')),
                ('minimum_enrollment', models.IntegerField(blank=True,
                                                           default=1)),
                ('maximum_enrollment', models.IntegerField(
                    blank=True,
                    default=20,
                    null=True)),
                ...
                ('type', models.CharField(blank=True, choices=[
                    ...
                    ], default=b'Lecture', max_length=128)),
                ('fee', models.IntegerField(blank=True, default=0, null=True)),
                ('other_teachers', models.CharField(blank=True,
                                                    max_length=128)),
                ('length_minutes', models.IntegerField(blank=True, choices=[
                    (60, b'60'),
                    (90, b'90'),
                    (120, b'120')], default=60)),
                ...
                ('space_needs', models.CharField(blank=True, choices=[
                    (b'Movement Class Floor', (
                        (b'0', b"Don't Care about Floor"),
                        (b'1', b'Carpet'),
                        (b'2', b'Dance Floor'),
                        (b'3', b'Both'))),
                    (b'Lecture Class Setup', (
                        ...
                        (b'5',
                         b'Lecture Style - tables and chairs face podium'),
                        (b'6', b'Conversational - seating in a ring')))
                    ], default=b'Please Choose an Option', max_length=128)),
                ('physical_restrictions', models.TextField(blank=True)),
                ('multiple_run', models.CharField(
                    choices=[(b'Yes', b'Yes'),
                             (b'No', b'No')],
                    default=b'No',
                    max_length=20)),
        ...
        migrations.CreateModel(
            name='Combo',
            fields=[
                ('performer_ptr', models.OneToOneField(
                    auto_created=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    parent_link=True,
                    primary_key=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_title', models.CharField(
                    ...
                    max_length=128,
                    null=True)),
                ('debut_date', models.CharField(
                    blank=True,
                    max_length=128,
                    null=True)),
                ('active_use', models.BooleanField(choices=[(True, b'Yes'),
                                                            (False, b'No')],
                                                   default=True)),
                ...
                ('pasties', models.BooleanField(choices=[(True, b'Yes'),
                                                         (False, b'No')],
                                                default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(
                    choices=[
                        (b'Special', b'Special Event'),
                        (b'Volunteer', b'Volunteer Opportunity'),
                        (b'Master', b'Master Class'),
                        (b'Drop-In', b'Drop-In Class'),
                        (b'Rehearsal Slot', b'Rehearsal Slot')],
                    default=b'Special',
                    max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('event_ptr', models.OneToOneField(
                    ...
                    serialize=False,
                    to='gbe.Event')),
                ('cue_sheet', models.CharField(choices=[
                    (b'Theater', b'Theater'),
                    (b'Alternate', b'Alternate'),
                    (b'None', b'None')], default=b'Theater', max_length=128)),
            ],
            bases=('gbe.event',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_physical_address', models.BooleanField(
                    default=False)),
                ('want_help', models.BooleanField(choices=[
                    (True, b'Yes'),
                    (False, b'No')], default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('biddable_ptr', models.OneToOneField(
                    ...
                    serialize=False,
                    to='gbe.Biddable')),
                ('number_shifts', models.IntegerField(choices=[
                    (2, 2),
                    (3, 3),
                    (4, 4),
                    (5, 5),
                ...
                ('pre_event', models.BooleanField(choices=[
                    (True, b'Yes'),
                    (False, b'No')], default=False)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name='secondary_vote', to='gbe.ShowVote'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='conf_volunteer', to='gbe.Persona'),
        ),
        migrations.AddField(
            model_name='combo',
            name='membership',
            field=models.ManyToManyField(related_name='combos',
                                         to='gbe.Persona'),
        ),
        migrations.AddField(
            model_name='class',
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='is_teaching', to='gbe.Persona'),
        ),
        migrations.AddField(
            model_name='actbidevaluation',
            name='bid',
