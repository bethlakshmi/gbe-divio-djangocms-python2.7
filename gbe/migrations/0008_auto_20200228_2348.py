# -*- coding: utf-8 -*-
# Generated by Django 1.11.27 on 2020-02-28 23:48
...
def centralize_techinfo(apps, schema_editor):
    ...
    for techinfo in TechInfo.objects.all():
        ...
        techinfo.confirm_no_music = techinfo.audio.confirm_no_music
        techinfo.track = techinfo.audio.track
...
def decentralize_techinfo(apps, schema_editor):
    ...
    for techinfo in TechInfo.objects.all():
        ...
        techinfo.audio.confirm_no_music = techinfo.confirm_no_music
        techinfo.audio.track = techinfo.track
