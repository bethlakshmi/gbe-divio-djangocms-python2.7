...
to show in our system.  If, after 1 hour, you continue to have problems, please 
<a href="/get-touch">contact us</a> for help with your problem.<br><br>
...
application (but you will be able to view it so you what information you applied with!)<br>
2) Fill out your application<br>
3) Click "save Draft".  You'll see your application listed in your personal pane with the
...
6) Your successfully submitted application will be viewable as a link in your personal pane;
...
fee, please wait 5 minutes and re-submit your application (go to your personal pane, click
"Click to Edit", and once your information is displayed, click the "Submit" button).  If the
