    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_submission_event', models.BooleanField(
                    default=False,
                    verbose_name=b'Act Fee')),
                ('vendor_submission_event', models.BooleanField(
                    default=False,
                    verbose_name=b'Vendor Fee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bpt_event', models.ForeignKey(
                    blank=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    to='ticketing.BrownPaperEvents')),
            ],
        ),
        migrations.CreateModel(
            name='Purchaser',
            fields=[
                ...
                ('matched_to_user', models.ForeignKey(
                    default=None,
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='ticketing_ticketingexclusion',
                to='ticketing.EligibilityCondition'),
        ),
        migrations.AddField(
            model_name='ticketingexclusion',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='ticketing_roleexclusion',
                to='ticketing.EligibilityCondition'),
        ),
        migrations.AddField(
            model_name='roleexclusion',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='ticketing_eligibilitycondition',
