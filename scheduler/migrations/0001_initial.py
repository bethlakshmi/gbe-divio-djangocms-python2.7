...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.IntegerField(blank=True, choices=[(4, b'A'), (3, b'B'), (2, b'C'), (1, b'D'), (0, b'F'), (None, b'NA')], null=True, validators=[django.core.validators.MinValueValidator(-1), django.core.validators.MaxValueValidator(5)])),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.Event')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_type', models.CharField(choices=[(b'grade', b'grade'), (b'text', b'text'), (b'boolean', b'boolean')], max_length=20)),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.ActItem')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('resource_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='scheduler.Resource')),
                ('role', models.CharField(blank=True, choices=[(b'Interested', b'Interested'), (b'Moderator', b'Moderator'), (b'Panelist', b'Panelist'), (b'Performer', b'Performer'), (b'Producer', b'Producer'), (b'Staff Lead', b'Staff Lead'), (b'Teacher', b'Teacher'), (b'Technical Director', b'Technical Director'), (b'Volunteer', b'Volunteer')], max_length=50)),
            ],
            bases=('scheduler.resource',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='resource',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allocations', to='scheduler.Resource'),
        ),
        migrations.AddField(
            model_name='ordering',
            name='allocation',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='scheduler.ResourceAllocation'),
        ),
        migrations.AddField(
            model_name='label',
            name='allocation',
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.EventEvalQuestion'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='worker',
            name='_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.WorkerItem'),
        ),
        migrations.AddField(
            model_name='location',
            name='_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.LocationItem'),
        ),
        migrations.AlterUniqueTogether(
            name='eventlabel',
